...
\fl{}\moduleLeftDash\cl{ {\MODULE} PoolSpec}\moduleRightDash\cl{}
\fl{}
\fl{ {\CONSTANT} Resources}
\fl{}
\fl{}
\fl{ {\CONSTANT} Consumers}
\fl{}
\fl{}
\fl{}
\fl{}
\fl{ {\VARIABLES}}\al{10}{1}{ resState ,\,}
\fl{ leases}
\fl{}
\fl{}
\fl{ vars \.{\defeq} {\langle} resState ,\, leases {\rangle}}
\fl{}
\fl{}
\fl{}
\fl{}
\fl{}
 \fl{ TypeOK \.{\defeq}}\al{20}{2}{ \.{\land}}\al{20}{3}{ \A\, r}\al{20}{5}{
 \.{\in}}\al{20}{6}{ Resources}\al{20}{7}{ \.{:}}\al{20}{8}{ resState [ r ]
 \.{\in} \{\@w{idle} ,\,\@w{claimed} \}}
 \fl{ \.{\land}}\al{21}{1}{ \A\, c}\al{21}{3}{ \.{\in}}\al{21}{4}{
 Consumers}\al{21}{5}{ \.{:}}\al{21}{6}{ leases [ c ] \.{\subseteq} Resources}
\fl{}
\fl{}
\fl{}
\fl{}
\fl{}
 \fl{ Init \.{\defeq}}\al{27}{2}{ \.{\land}}\al{27}{3}{ resState \.{=} [ r
 \.{\in} Resources \.{\mapsto}\@w{idle} ]}
 \fl{ \.{\land}}\al{28}{1}{ leases \.{=} [ c \.{\in} Consumers \.{\mapsto} \{
 \} ]}
\fl{}
\fl{}
\fl{}
\fl{}
 \fl{ Checkout ( r ,\, c ) \.{\defeq}}\al{33}{7}{ \.{\land}}\al{33}{8}{
 resState [ r ] \.{=}\@w{idle}}
 \fl{ \.{\land}}\al{34}{1}{ resState \.{'} \.{=} [ resState {\EXCEPT} {\bang}
 [ r ] \.{=}\@w{claimed} ]}
 \fl{ \.{\land}}\al{35}{1}{ leases \.{'} \.{=} [ leases {\EXCEPT} {\bang} [ c
 ] \.{=} leases [ c ] \.{\cup} \{ r \} ]}
\fl{}
\fl{}
\fl{}
\fl{}
\fl{}
 \fl{ Checkin ( r ) \.{\defeq}}\al{41}{5}{ \.{\land}}\al{41}{6}{ resState [ r
 ] \.{=}\@w{claimed}}
 \fl{ \.{\land}}\al{42}{1}{ resState \.{'} \.{=} [ resState {\EXCEPT} {\bang}
 [ r ] \.{=}\@w{idle} ]}
 \fl{ \.{\land}}\al{43}{1}{ leases \.{'} \.{=} [ c \.{\in} Consumers
 \.{\mapsto} leases [ c ] \.{\,\backslash\,} \{ r \} ]}
\fl{}
\fl{}
 \fl{ Next \.{\defeq} \E\, r \.{\in} Resources \.{:}}\al{46}{7}{
 \.{\lor}}\al{46}{8}{ Checkin ( r )}
\fl{ \.{\lor}}\al{47}{1}{ \E\, c \.{\in} Consumers \.{:} Checkout ( r ,\, c )}
\fl{}
\fl{}
\fl{}
\fl{}
...
\fl{}
\fl{}
 \fl{ ClaimedStateConsistent \.{\defeq} \A\, r \.{\in} Resources
 \.{:}}\al{60}{7}{ \.{\lor}}\al{60}{8}{ \.{\land}}\al{60}{9}{ resState [ r ]
 \.{=}\@w{claimed}}
 \fl{ \.{\land}}\al{61}{1}{ \E\, c \.{\in} Consumers \.{:} r \.{\in} leases [
 c ]}
\fl{ \.{\lor}}\al{62}{1}{ \.{\land}}\al{62}{2}{ resState [ r ] \.{=}\@w{idle}}
 \fl{ \.{\land}}\al{63}{1}{ \A\, c \.{\in} Consumers \.{:} r \.{\notin} leases
 [ c ]}
\fl{}
\fl{}
\fl{}
\fl{}
\fl{ OnlyOneOwner \.{\defeq} \A\,}\al{68}{3}{ c \.{\in} Consumers \.{:}}
 \fl{ \A\, c2 \.{\in} Consumers \.{:}}\al{69}{5}{ \.{\lor}}\al{69}{6}{ c \.{=}
 c2}
\fl{ \.{\lor}}\al{70}{1}{ leases [ c ] \.{\cap} leases [ c2 ] \.{=} \{ \}}
\fl{}
\fl{}
\fl{}
\fl{}
